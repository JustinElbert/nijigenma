                                ...
                                <div class="card d-flex flex-column h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p><a href="/categories/{{ $post->category->slug }}"
                                                class="text-decoration-none text-secondary">{{ $post->category->username }}</a>
                                        </p>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col bg-warning"
                                                ...
                                                <a href="/dashboard/posts/{{ $post->slug }}/edit" style="text-decoration: none">
                                            ...
                                            <div class="col bg-danger">
                                                <form action="/dashboard/posts/{{ $post->slug }}" method="post">
                                                    ...
                                                    <button type="submit" class="btn btn-danger"
                                                        style="padding-top: 0.5rem; padding-bottom: 0.5rem; width:100%; border: none; background-color: inherit; color: black;"
